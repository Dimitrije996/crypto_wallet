...
@Controller
public class KorisnikStranaKontroller implements WebMvcConfigurer {
    ...
    public KorisnikStranaKontroller(KorisniciRepozitorijum korisniciRepozitorijum, MarketRepozitorijum marketRepozitorijum) {
        this.korisniciRepozitorijum = korisniciRepozitorijum;
        this.marketRepozitorijum = marketRepozitorijum;
    }

    @GetMapping("korisnikHome")
    public String korisnikHome(@AuthenticationPrincipal KorisnikoviPodaci korisnikoviPodaci, Model model){
